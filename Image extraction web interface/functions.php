...
function db_connect (){
	...
	$servername = "localhost";
	$username = "onewoma8_newtime";
	$password = 'f*0Q1C[@gedk';
	$db = "onewoma8_TIME_new";
...
//NOTE EDIT HERE.  Original was ($count2/$batch_size) > ($count1)
...
function crop_image(){
	...
	//changing directory name here for testing from faces to faces-test
	$path = "faces-test/".$file_data[0]."-".$file_data[1]."-".$file_data[2];
	$img_height = $_POST["img_height"];
